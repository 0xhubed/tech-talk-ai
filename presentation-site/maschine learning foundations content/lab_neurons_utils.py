...
def plt_linear(X_train, Y_train, prediction_tf, prediction_np):
    ...
    ax[0].set_ylabel('Price (in 1000s of chf)', fontsize='xx-large')
    ax[0].set_xlabel('Size (100 m2)', fontsize='xx-large')
    ...
    ax[1].set_ylabel('Price (in 1000s of chf)', fontsize='xx-large')
    ax[1].set_xlabel('Size (100 m2)', fontsize='xx-large')
